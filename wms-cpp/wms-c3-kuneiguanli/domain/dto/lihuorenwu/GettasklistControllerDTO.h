...
class GettasklistControllerlistDTO : public oatpp::DTO
{
	DTO_INIT(GettasklistControllerlistDTO, DTO);
 ...
 */
  ...
  class GettasklistControllerBatchDTO : public oatpp::DTO {
	DTO_INIT(GettasklistControllerBatchDTO, DTO);
	DTO_FIELD(Vector<Object<GettasklistControllerlistDTO>>, items);
  ...
  class GettasklistControllerDTO : public GettasklistControllerlistDTO {
	  DTO_INIT(GettasklistControllerDTO, GettasklistControllerlistDTO);
  };

/**
 * "理货任务" - 分页数据对象
 */
class GettasklistControllerPageDTO : public PageDTO<GettasklistControllerDTO::Wrapper>
{
	DTO_INIT(GettasklistControllerPageDTO, PageDTO<GettasklistControllerDTO::Wrapper>);
};
